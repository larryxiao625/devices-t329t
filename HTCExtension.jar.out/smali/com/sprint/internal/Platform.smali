...
.method public static getCdmaPrlVersion()Ljava/lang/String;
    ...
    .prologue
    .line 293
    sget-boolean v7, Lcom/sprint/internal/SystemProperties;->IS_NOT_SPC_PROJECT:Z
    ...
    :cond_1
    const-string v7, "com.sprint.internal.permission.PLATFORM"

    invoke-static {v7}, Lcom/sprint/internal/SecurityManager;->checkPermission(Ljava/lang/String;)Z
    ...
    .line 302
    sget-object v7, Lcom/sprint/internal/Platform;->TAG:Ljava/lang/String;
    ...
    .line 305
    .restart local v1       #at:Landroid/app/ActivityThread;
    if-nez v1, :cond_2

    .line 306
    sget-object v7, Lcom/sprint/internal/Platform;->TAG:Ljava/lang/String;

    const-string v8, "currentActivityThread null"
    ...
    const-string v8, "system main null....."
    ...
    const-string v8, "****** require PLATFORM permission!!****** "
    ...
    const-string v9, "caller process name"
    ...
    const-string v8, "currentApplication null"
    ...
    const-string v8, "systemContext null...."
    ...
    const-string v9, "caller package name"
    ...
    .line 336
    .local v4, mPkgInfo:Landroid/content/pm/PackageInfo;
    iget-object v2, v4, Landroid/content/pm/PackageInfo;->signatures:[Landroid/content/pm/Signature;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 349
    .end local v4           #mPkgInfo:Landroid/content/pm/PackageInfo;
    :cond_8
    :goto_2
    if-eqz v2, :cond_9

    invoke-static {v2}, Lcom/sprint/internal/Platform;->htcCheckCompatibility([Landroid/content/pm/Signature;)Z
    ...
    const-string v8, "a.getPackageName  NULL!!!!"
    ...
    .line 346
    .restart local v5       #mPm:Landroid/content/pm/PackageManager;
    :catch_0
    move-exception v3
    ...
    .line 366
    .local v6, prl_prop:Ljava/lang/String;
    sget-boolean v7, Lcom/sprint/internal/SystemProperties;->DBG:Z
    ...
    const-string v9, "getCdmaPrlVersion:"
...
.method public enableScreenTimeout()V
    ...
    const-string/jumbo v6, "user already enableScreenTimeout"
