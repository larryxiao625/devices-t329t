...
.method private addPenType(Lcom/htc/painting/penmenu/PenType;)Lcom/htc/painting/penmenu/PenType;
    ...
    const-string v5, "addPenType - add pen type: "
    ...
    const-string v5, "addPenType - pen type has existed: "
...
.method private getCurrentPen(Landroid/content/Context;)Lcom/htc/painting/penmenu/Pen;
    ...
    const-string v6, "getCurrentPen - start"
    ...
    const-string v6, "getCurrentPen - no current pen found, use default pen instead!"
    ...
    const-string v6, "getCurrentPen - clean mode return default pen"
    ...
    const-string v7, "getCurrentPen - return: "
...
.method private getDefaultHistoryPens(Ljava/util/List;ZLandroid/content/Context;)I
    ...
    .line 1224
    const-string v8, "PenManager"

    const-string v9, "getDefaultHistoryPens - mPenTypeList is null or empty"
    ...
    const-string v10, "getDefaultHistoryPens - add: "
...
.method private getDefaultPen(Landroid/content/Context;)Lcom/htc/painting/penmenu/Pen;
    ...
    const-string v11, "getDefaultPen - begin"
    ...
    const-string v12, "getDefaultPen - return: "
...
.method private getHistoryPens(ZLandroid/content/Context;)Ljava/util/List;
    ...
    const-string v7, "getHistoryPens - start"
    ...
    const-string v7, "getHistoryPens - no pens found, return default list!"
    ...
    const-string v8, "getHistoryPens - add pen: "
    ...
    const-string v7, "getHistoryPens - clean mode return default list!"
    ...
    .restart local v2       #penStrings:[Ljava/lang/String;
    .restart local v4       #stringToParse:Ljava/lang/String;
    :cond_c
    sget-boolean v6, Lcom/htc/htcjavaflag/HtcBuildFlag;->Htc_DEBUG_flag:Z
    ...
    const-string v8, "getHistoryPens - return "
...
.method private loadMostRecentPenTypeConfig(Landroid/content/Context;)V
    ...
    const-string v11, "loadMostRecentPenTypePen - start"
    ...
    const-string v11, "loadMostRecentPenTypePen - use default pens"
    ...
    const-string v12, "loadMostRecentPenTypePen - put default pen for: "
    ...
    const-string v12, "loadMostRecentPenTypePen - put pen: "
    ...
    const-string v11, "loadMostRecentPenTypePen - end"
...
.method private loadPenType(Landroid/content/Context;)V
    ...
    const-string v2, "loadPenType - end!"
...
.method private notifyLoadFinish()V
    ...
    const-string v3, "notifyLoadFinish - listener null: "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v1, p0, Lcom/htc/painting/penmenu/PenManager;->mPenTypeLoadingListener:Lcom/htc/painting/penmenu/PenManager$IPenTypeLoadingListener;
    ...
    .line 372
    .end local v0           #penTypeLoadingListener:Lcom/htc/painting/penmenu/PenManager$IPenTypeLoadingListener;
    :cond_2
...
.method private declared-synchronized refreshPenTypeList(Ljava/util/List;Landroid/content/Context;)V
    ...
    const-string v5, "refreshPenTypeList - got pen type: "
...
.method private refreshPenTypes(Landroid/content/Context;)V
    ...
    const-string v1, "refreshPenTypes begin!"
    ...
    invoke-virtual {v0, v2}, Lcom/htc/painting/penmenu/PenManager$PenTypeLoadingHandler;->removeMessages(I)V

    .line 282
    iget-object v0, p0, Lcom/htc/painting/penmenu/PenManager;->mPenTypeLoadingHandler:Lcom/htc/painting/penmenu/PenManager$PenTypeLoadingHandler;

    invoke-virtual {v0, v2}, Lcom/htc/painting/penmenu/PenManager$PenTypeLoadingHandler;->sendEmptyMessage(I)Z
...
.method getFromSharedPref(Ljava/lang/String;Ljava/lang/Object;Landroid/content/Context;)Ljava/lang/Object;
    ...
    const-string v5, "getFromSharedPref - penset: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/htc/painting/penmenu/PenManager;->mPenSetType:I
...
.method declared-synchronized getPenTypeResource(ILcom/htc/painting/penmenu/PenManager$PenTypeResources;Landroid/content/Context;)Z
    ...
    .line 436
    const-string v7, "PenManager"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "getPenTypeResource - pen set type: "
    ...
    const-string v8, "getPenTypeResource - return false, can\'t find current pen"
    ...
    const-string v7, "getPenTypeResource - return true"
    ...
    const-string v8, "getPenTypeResource - return false, mPenTypeList is null/empty"
...
.method initPenTypes(Landroid/content/Context;)Z
    ...
    const-string v3, "initPenTypes begin!"
    ...
    const-string v3, "initPenTypes end!"
    ...
    const-string v2, "initPenTypes end without send message"
...
.method queryGlobalSetting(Ljava/lang/String;Ljava/lang/Object;Landroid/content/Context;)Ljava/lang/Object;
    ...
    const-string/jumbo v3, "where penset_type = ?"
...
.method setToSharedPref(Ljava/lang/String;Ljava/lang/Object;Landroid/content/Context;)Z
    ...
    const-string v6, "setToSharedPref - penset: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p0, Lcom/htc/painting/penmenu/PenManager;->mPenSetType:I
...
.method updateGlobalSetting(Ljava/lang/String;Ljava/lang/Object;Landroid/content/Context;)Z
    ...
    const-string/jumbo v5, "updateGlobalSetting - no save value specified!"
    ...
    const-string/jumbo v6, "where penset_type = ?"
    ...
    const-string/jumbo v7, "updateGlobalSetting - not supported class: "
