...
.method private setupFontEnvironment()V
    ...
    .line 140
    :cond_1
    sget-boolean v3, Lcom/htc/widget/ActionBarContainer;->enableDebug:Z
    ...
    const-string v5, "setupFontEnvironment():"
    ...
    :pswitch_2
    iput v6, p0, Lcom/htc/widget/ActionBarText;->primaryMargin:I
...
.method public onResourceUpdate()V
    ...
    const-string v2, "onResourceUpdate():"
...
.method setBackUpEnabled(Z)V
    ...
    .line 480
    :cond_0
    sget-boolean v0, Lcom/htc/widget/ActionBarContainer;->enableDebug:Z
