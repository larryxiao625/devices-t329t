...
.field private static final MESSAGE_DELAY_SYNC_IN_INIT:I = 0xa
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1702
    .local v10, earliestFuturePollTime:J
    ...
    iget-object v3, v0, Landroid/content/SyncManager$SyncHandler;->this$0:Landroid/content/SyncManager;

    #calls: Landroid/content/SyncManager;->readDataConnectionState()Z
    invoke-static {v3}, Landroid/content/SyncManager;->access$500(Landroid/content/SyncManager;)Z

    move-result v3

    #setter for: Landroid/content/SyncManager;->mDataConnectionIsConnected:Z
    invoke-static {v2, v3}, Landroid/content/SyncManager;->access$402(Landroid/content/SyncManager;Z)Z
    ...
    invoke-static {v2}, Landroid/content/SyncManager;->access$2000(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-direct {v0, v10, v11, v14, v15}, Landroid/content/SyncManager$SyncHandler;->manageSyncAlarmLocked(JJ)V

    .line 1823
    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/content/SyncManager$SyncHandler;->mSyncTimeTracker:Landroid/content/SyncManager$SyncTimeTracker;

    invoke-virtual {v2}, Landroid/content/SyncManager$SyncTimeTracker;->update()V
    ...
    const-string v3, "In msg:MESSAGE_DELAY_SYNC_IN_INIT"
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/content/SyncManager;->scheduleSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;JZ)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object v3, v0, Landroid/content/SyncManager$SyncHandler;->mSyncTimeTracker:Landroid/content/SyncManager$SyncTimeTracker;
    ...
    #getter for: Landroid/content/SyncManager;->mSyncManagerWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v3}, Landroid/content/SyncManager;->access$2000(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    .line 1728
    .local v17, payload:Landroid/util/Pair;,"Landroid/util/Pair<Landroid/accounts/Account;Ljava/lang/String;>;"
    const-string v2, "SyncManager"
    ...
    const-string v4, "handleSyncHandlerMessage: MESSAGE_SERVICE_CANCEL: "
    ...
    invoke-direct {v0, v2, v3}, Landroid/content/SyncManager$SyncHandler;->cancelActiveSyncLocked(Landroid/accounts/Account;Ljava/lang/String;)V
    ...
    .line 1738
    .end local v17           #payload:Landroid/util/Pair;,"Landroid/util/Pair<Landroid/accounts/Account;Ljava/lang/String;>;"
    :pswitch_3
    const-string v2, "SyncManager"
    ...
    const-string v3, "handleSyncHandlerMessage: MESSAGE_SYNC_FINISHED"
    ...
    check-cast v16, Landroid/content/SyncManager$SyncHandlerMessagePayload;

    .line 1742
    .local v16, payload:Landroid/content/SyncManager$SyncHandlerMessagePayload;
    move-object/from16 v0, p0
    ...
    iget-object v3, v0, Landroid/content/SyncManager$SyncHandlerMessagePayload;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;

    #calls: Landroid/content/SyncManager;->isSyncStillActive(Landroid/content/SyncManager$ActiveSyncContext;)Z
    invoke-static {v2, v3}, Landroid/content/SyncManager;->access$2100(Landroid/content/SyncManager;Landroid/content/SyncManager$ActiveSyncContext;)Z
    ...
    iget-object v4, v0, Landroid/content/SyncManager$SyncHandlerMessagePayload;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    ...
    iget-object v2, v0, Landroid/content/SyncManager$SyncHandlerMessagePayload;->syncResult:Landroid/content/SyncResult;
    ...
    invoke-direct {v0, v2, v3}, Landroid/content/SyncManager$SyncHandler;->runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Landroid/content/SyncManager$ActiveSyncContext;)V
    ...
    .line 1755
    .end local v16           #payload:Landroid/content/SyncManager$SyncHandlerMessagePayload;
    :pswitch_4
    move-object/from16 v0, p1

    iget-object v13, v0, Landroid/os/Message;->obj:Ljava/lang/Object;

    check-cast v13, Landroid/content/SyncManager$ServiceConnectionData;

    .line 1756
    .local v13, msgData:Landroid/content/SyncManager$ServiceConnectionData;
    const-string v2, "SyncManager"
    ...
    iget-object v4, v13, Landroid/content/SyncManager$ServiceConnectionData;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    ...
    iget-object v3, v13, Landroid/content/SyncManager$ServiceConnectionData;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    ...
    .line 1762
    iget-object v2, v13, Landroid/content/SyncManager$ServiceConnectionData;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;

    iget-object v3, v13, Landroid/content/SyncManager$ServiceConnectionData;->syncAdapter:Landroid/content/ISyncAdapter;

    move-object/from16 v0, p0

    invoke-direct {v0, v2, v3}, Landroid/content/SyncManager$SyncHandler;->runBoundToSyncAdapter(Landroid/content/SyncManager$ActiveSyncContext;Landroid/content/ISyncAdapter;)V

    goto/16 :goto_0

    .line 1768
    .end local v13           #msgData:Landroid/content/SyncManager$ServiceConnectionData;
    :pswitch_5
    move-object/from16 v0, p1

    iget-object v2, v0, Landroid/os/Message;->obj:Ljava/lang/Object;

    check-cast v2, Landroid/content/SyncManager$ServiceConnectionData;

    iget-object v9, v2, Landroid/content/SyncManager$ServiceConnectionData;->activeSyncContext:Landroid/content/SyncManager$ActiveSyncContext;

    .line 1770
    .local v9, currentSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    const-string v2, "SyncManager"
    ...
    const-string v4, "handleSyncHandlerMessage: MESSAGE_SERVICE_DISCONNECTED: "
    ...
    #calls: Landroid/content/SyncManager;->isSyncStillActive(Landroid/content/SyncManager$ActiveSyncContext;)Z
    invoke-static {v2, v9}, Landroid/content/SyncManager;->access$2100(Landroid/content/SyncManager;Landroid/content/SyncManager$ActiveSyncContext;)Z
    ...
    .line 1778
    iget-object v2, v9, Landroid/content/SyncManager$ActiveSyncContext;->mSyncAdapter:Landroid/content/ISyncAdapter;
    :try_end_2
    ...
    invoke-interface {v2, v9}, Landroid/content/ISyncAdapter;->cancelSync(Landroid/content/ISyncContext;)V
    :try_end_3
    ...
    invoke-direct {v0, v1, v9}, Landroid/content/SyncManager$SyncHandler;->runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Landroid/content/SyncManager$ActiveSyncContext;)V
    ...
    .line 1800
    .end local v9           #currentSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    ...
    const-string v3, "handleSyncHandlerMessage: MESSAGE_SYNC_ALARM"
    ...
    iput-object v2, v0, Landroid/content/SyncManager$SyncHandler;->mAlarmScheduleTime:Ljava/lang/Long;
    :try_end_4
    ...
    invoke-static {v2}, Landroid/content/SyncManager;->access$800(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    #getter for: Landroid/content/SyncManager;->mHandleAlarmWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v3}, Landroid/content/SyncManager;->access$800(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    const-string v3, "handleSyncHandlerMessage: MESSAGE_CHECK_ALARMS"
    ...
    .line 1781
    .restart local v9       #currentSyncContext:Landroid/content/SyncManager$ActiveSyncContext;
    :catch_0
    move-exception v2
