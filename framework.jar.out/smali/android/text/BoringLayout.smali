...
.method public static isBoring(Ljava/lang/CharSequence;Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;Landroid/text/BoringLayout$Metrics;)Landroid/text/BoringLayout$Metrics;
    ...
    :cond_2
    :goto_2
    invoke-static/range {v24 .. v24}, Landroid/text/TextUtils;->recycle([C)V
    ...
    .line 302
    .local v22, sp:Landroid/text/Spanned;
    const/4 v5, 0x0
    ...
    .line 303
    .local v23, styles:[Ljava/lang/Object;
    ...
    .line 308
    .end local v22           #sp:Landroid/text/Spanned;
    .end local v23           #styles:[Ljava/lang/Object;
    :cond_3
    if-eqz v14, :cond_a
    ...
    .line 273
    .local v19, ignore:Ljava/lang/StringIndexOutOfBoundsException;
    ...
    .line 283
    .end local v19           #ignore:Ljava/lang/StringIndexOutOfBoundsException;
    ...
    .end local v20           #j:I
    .end local v21           #n:I
    .restart local v4       #line:Landroid/text/TextLine;
    .restart local v17       #fm:Landroid/text/BoringLayout$Metrics;
    :catch_1
    move-exception v16
    ...
    const-string v5, "BoringLayout"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Exception occured in isBoring(), "
