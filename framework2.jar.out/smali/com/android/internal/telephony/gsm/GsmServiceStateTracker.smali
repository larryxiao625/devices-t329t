...
.method private pollStateDone()V
    ...
    sget-boolean v32, Lcom/android/internal/telephony/gsm/GSMPhone;->mDropEvent:Z
    ...
    const-string v33, " pollStateDone drop event "
    ...
    const-string v33, " oldMaxDataCalls="
    ...
    const-string v33, " mNewMaxDataCalls="
    ...
    const-string v33, " oldReasonDataDenied="
    ...
    const-string v33, " mNewReasonDataDenied="
    ...
    const-string v34, "Set the hasRegistered ="
    ...
    const-string v34, "due to there has network change during poll state"
    ...
    const-string v34, "reset the mCregChange ="
    ...
    const-string v34, "Set the hasGprsAttached ="
    ...
    const-string v34, "reset the mCgregChange ="
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/telephony/ServiceState;->getRadioTechnology()I
    ...
    const-string v34, "MM Reject Cause: "
    ...
    invoke-virtual/range {v32 .. v33}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyMMLocationUpdateInfo([I)V
    ...
    invoke-virtual/range {v32 .. v34}, Lcom/android/internal/telephony/gsm/GSMPhone;->updateNetworkTypeGlobally(ZLjava/lang/Integer;)Z
    ...
    const-string v34, "CSFB, notify signal strength again here, "
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifySignalStrength()V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/gsm/GSMPhone;->processRestartManualNetworkSelection()V
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/gsm/GSMPhone;->checkTestIcc()Z
    ...
    const-string v34, "fixTimeZone mOPERATOR_ISO_COUNTRY: "
    ...
    .line 1894
    const-string v32, "persist.sys.timezone"
    ...
    .line 1896
    .local v22, needLaunchTimeZonePicker:Z
    move-object/from16 v0, p0
    ...
    invoke-static/range {v32 .. v33}, Ljava/util/Arrays;->binarySearch([Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    const-string v34, "mZoneOffset:0, mZoneDst:false, zoneName != null, zone:"
    ...
    const-string v34, "fixTimeZone is done zone:"
    ...
    const-string v34, "pollStateDone AUTO_TIME_ZONE update time zone: "
    ...
    .line 1962
    .end local v22           #needLaunchTimeZonePicker:Z
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/gsm/GSMPhone;->getPhoneType()I
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/gsm/GSMPhone;->getICCRecords()Lcom/android/internal/telephony/IccRecords;

    move-result-object v24

    check-cast v24, Lcom/android/internal/telephony/gsm/SIMRecords;

    .line 1974
    .local v24, simRecord:Lcom/android/internal/telephony/gsm/SIMRecords;
    if-eqz v24, :cond_12

    .line 1975
    invoke-virtual/range {v24 .. v24}, Lcom/android/internal/telephony/gsm/SIMRecords;->queryCFUIfNecessary()V

    .line 1982
    .end local v24           #simRecord:Lcom/android/internal/telephony/gsm/SIMRecords;
    :cond_12
    move-object/from16 v0, p0
    ...
    const-string v33, "nwTypeChanged"

    const-string v34, "*"

    invoke-virtual/range {v32 .. v34}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyDataConnection(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v33, "onSignalStrengthResult() Phone already destroyed: "
    ...
    const-string v33, "SignalStrength not notified"
    ...
    const-string v33, "device has deregistered due to airplane on"
    ...
    .restart local v22       #needLaunchTimeZonePicker:Z
    ...
    .line 1924
    .local v26, testOperatorMCC:Ljava/lang/String;
    ...
    const-string v34, "test operator :"
    ...
    const-string v34, " for iso is empty"
    ...
    invoke-static/range {v32 .. v36}, Landroid/util/TimeUtils;->getTimeZone(IZJLjava/lang/String;)Ljava/util/TimeZone;
    ...
    const-string v33, "to figure out time zone in no iso case"
    ...
    .line 1937
    .end local v26           #testOperatorMCC:Ljava/lang/String;
    :cond_2e
    move-object/from16 v0, p0
    ...
    const-string v33, "fixTimeZone zone is null"
