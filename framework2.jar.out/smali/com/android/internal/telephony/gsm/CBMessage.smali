...
.method public static newFromCBM([Ljava/lang/String;)Lcom/android/internal/telephony/gsm/CBMessage;
    ...
    const-string v4, "Cell broadcast"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "1-newFromCBM()-cb:"
    ...
    .line 144
    :cond_0
    new-instance v3, Lcom/android/internal/telephony/gsm/CBMessage;

    invoke-direct {v3}, Lcom/android/internal/telephony/gsm/CBMessage;-><init>()V

    .line 147
    .local v3, msg:Lcom/android/internal/telephony/gsm/CBMessage;
    ...
    invoke-direct {v2, v4}, Lcom/android/internal/telephony/gsm/SmsCbHeader;-><init>([B)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/gsm/CBMessage;->parseEtwsCBPdu([B)V

    .line 165
    .end local v1           #format:I
    .end local v2           #header:Lcom/android/internal/telephony/gsm/SmsCbHeader;
    .end local v3           #msg:Lcom/android/internal/telephony/gsm/CBMessage;
    :goto_0
    return-object v3
    ...
    .restart local v3       #msg:Lcom/android/internal/telephony/gsm/CBMessage;
    :cond_1
    const/4 v4, 0x2
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/gsm/CBMessage;->parseUmtsCBPdu([B)V
    :try_end_0
    ...
    const-string v5, "CB PDU parsing failed: "
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/gsm/CBMessage;->parseCBPdu([B)V
    :try_end_1
