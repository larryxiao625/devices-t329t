...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;)V
    ...
    const-string v1, "HtcGlAnimManager is created !!"
...
.method private checkContinuousTrans()V
    ...
    sget-boolean v2, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_ANIM:Z
    ...
    iget v4, p0, Lcom/android/server/wm/HtcGlAnimManager;->DELTA_CONTINUOUS_ANIM:I
...
.method private doRecentAppTransition(IZ)V
    ...
    .line 1005
    :cond_0
    iput-boolean v9, p0, Lcom/android/server/wm/HtcGlAnimManager;->mIsRecentAppInvolve:Z

    .line 1006
    iput-boolean v9, p0, Lcom/android/server/wm/HtcGlAnimManager;->mIsOverrideAppTranAnim:Z
...
.method public applyAnimationLockedInner(Lcom/android/server/wm/AppWindowToken;Landroid/view/animation/Animation;Z)Z
    ...
    sget-boolean v5, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_ANIM_CHOOSEN:Z
...
.method public cleanAnimParamsLocked()V
    ...
    sget-boolean v0, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_ANIM:Z
...
.method public clearCurrentAnimationLocked()V
    ...
    sget-boolean v3, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_TO_NATIVE:Z
...
.method public includeWindowForAnimationLocked(Lcom/android/server/wm/WindowState;Landroid/view/WindowManager$LayoutParams;III)V
    ...
    .prologue
    .line 525
    iget-object v11, p0, Lcom/android/server/wm/HtcGlAnimManager;->mAnimatingWindows:Ljava/util/List;
    ...
    iget-object v11, p1, Lcom/android/server/wm/WindowState;->mSurface:Landroid/view/Surface;
    ...
    iget-object v11, v11, Lcom/android/server/wm/AppWindowToken;->mHtcGlAnimation:Lcom/htc/view/animation/HtcBaseGlTransAnim;
    ...
    sget-boolean v11, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_TO_NATIVE:Z

    if-eqz v11, :cond_0

    .line 531
    const-string v11, "HtcGlAnimation"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "include the Window:"
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/server/wm/WindowState;->isFullscreen(II)Z
    ...
    .line 544
    sget-boolean v11, Lcom/android/server/wm/HtcGlAnimManager;->HIDE_STATUS_BAR:Z
    ...
    invoke-virtual {v11}, Lcom/android/server/wm/AppWindowToken;->findMainWindow()Lcom/android/server/wm/WindowState;

    move-result-object v8

    .line 548
    .local v8, mainWin:Lcom/android/server/wm/WindowState;
    if-eqz v8, :cond_2
    ...
    .line 563
    .end local v8           #mainWin:Lcom/android/server/wm/WindowState;
    .local v5, isHideStatusBarArea:Z
    :goto_0
    iget-object v11, p1, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iget-object v11, v11, Lcom/android/server/wm/AppWindowToken;->mHtcGlAnimation:Lcom/htc/view/animation/HtcBaseGlTransAnim;

    invoke-virtual {v11, v5}, Lcom/htc/view/animation/HtcBaseGlTransAnim;->setIsHideStatusBarArea(Z)V
    ...
    .line 580
    .local v6, isMainWindow:Z
    :goto_1
    iget-object v11, p1, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iget-object v11, v11, Lcom/android/server/wm/AppWindowToken;->mHtcGlAnimation:Lcom/htc/view/animation/HtcBaseGlTransAnim;

    invoke-virtual {v11, v6}, Lcom/htc/view/animation/HtcBaseGlTransAnim;->setIsMainWindow(Z)V
    ...
    invoke-virtual {v11}, Lcom/htc/view/animation/HtcBaseGlTransAnim;->encodeGlobalParamsToArray()[Ljava/lang/String;

    move-result-object v9

    .line 585
    .local v9, outputGParams:[Ljava/lang/String;
    sget-boolean v11, Lcom/htc/htcjavaflag/HtcBuildFlag;->Htc_DEBUG_flag:Z
    ...
    const-string v12, "encodeGlobalParams Complete! The String array is:"
    ...
    const-string v13, "mGlAttributeSet[i]= "
    ...
    .end local v4           #i$:I
    .end local v5           #isHideStatusBarArea:Z
    .end local v6           #isMainWindow:Z
    .end local v7           #len$:I
    .end local v9           #outputGParams:[Ljava/lang/String;
    .restart local v8       #mainWin:Lcom/android/server/wm/WindowState;
    :cond_2
    const/4 v5, 0x1

    .restart local v5       #isHideStatusBarArea:Z
    goto :goto_0
    ...
    .restart local v6       #isMainWindow:Z
    goto :goto_1
    ...
    .line 592
    .restart local v9       #outputGParams:[Ljava/lang/String;
    :cond_7
    iget-object v11, p1, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iget-object v11, v11, Lcom/android/server/wm/AppWindowToken;->mHtcGlAnimation:Lcom/htc/view/animation/HtcBaseGlTransAnim;

    invoke-virtual {v11}, Lcom/htc/view/animation/HtcBaseGlTransAnim;->encodeSpecificParamsToArray()[Ljava/lang/String;

    move-result-object v10

    .line 593
    .local v10, outputSParams:[Ljava/lang/String;
    sget-boolean v11, Lcom/htc/htcjavaflag/HtcBuildFlag;->Htc_DEBUG_flag:Z
    ...
    const-string v12, "encodeSpecificParams Complete! The String array is:"
    ...
    invoke-virtual {v11, v9, v10}, Landroid/view/Surface;->set3DAnimationAttribute([Ljava/lang/String;[Ljava/lang/String;)V

    .line 601
    const/high16 v11, -0x4080

    iput v11, p1, Lcom/android/server/wm/WindowState;->mLastAnimProgress:F

    .line 603
    .end local v5           #isHideStatusBarArea:Z
    .end local v6           #isMainWindow:Z
    .end local v9           #outputGParams:[Ljava/lang/String;
    .end local v10           #outputSParams:[Ljava/lang/String;
    :cond_9
    return-void
.end method
...
.method public progressAnimationLocked()V
    ...
    sget-boolean v3, Lcom/android/server/wm/HtcGlAnimManager;->DEBUG_ANIM_PROGRESS:Z
...
.method public setAnimationDuration(I)V
    ...
    iget v2, p0, Lcom/android/server/wm/HtcGlAnimManager;->mSetAppTranAnimDuration:I
...
.method public setAnimationRate(I)V
    ...
    iget v2, p0, Lcom/android/server/wm/HtcGlAnimManager;->mSetAppTranAnimRate:I
...
.method public setTransitLocked(I)V
    ...
    .line 274
    invoke-direct {p0, p1}, Lcom/android/server/wm/HtcGlAnimManager;->debugTransitType(I)V
