...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z
...
.method private doCommandLocked(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 293
    .local v0, code:I
    sget-boolean v8, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z

    if-eqz v8, :cond_0

    iget-object v8, p0, Lcom/android/server/NativeDaemonConnector;->TAG:Ljava/lang/String;

    const-string v9, "already send Command (Wait Response)"
    ...
    const-string v9, "finish send Command (complete)"
...
.method private listenToSocket()V
    ...
    .line 217
    :try_start_6
    sget-boolean v18, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z
    ...
    const-string v19, "listenToSocket read--: (%d,%d)"
    ...
    .line 217
    :try_start_11
    sget-boolean v19, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z
    ...
    const-string v20, "closing socket"
...
.method private sendCommandLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 245
    :cond_1
    sget-boolean v3, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/server/NativeDaemonConnector;->TAG:Ljava/lang/String;

    const-string v4, "SND -> {%s} {%s}"
...
.method public doListCommand(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    .line 372
    :try_start_2
    sget-boolean v12, Lcom/android/server/NativeDaemonConnector;->LOCAL_LOGD:Z
